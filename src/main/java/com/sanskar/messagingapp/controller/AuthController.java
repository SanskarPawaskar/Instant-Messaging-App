...
import com.sanskar.messagingapp.request.LoginRequest;
import com.sanskar.messagingapp.response.AuthResponse;
import com.sanskar.messagingapp.service.CustomUserService;
...
public class AuthController {
	...
	public ResponseEntity<AuthResponse> createUserHandler(@RequestBody User user) throws UserException{
		...
		String password = user.getPassoword();
		...
		createdUser.setPassoword(passwordEncoder.encode(password));
